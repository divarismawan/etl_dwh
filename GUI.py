...
class GUI_DWH(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.m_dataViewListColumn29 = self.m_dataViewList_member.AppendTextColumn(u"Date")
        ...
        self.m_dataViewListColumn45 = self.m_dataViewListCtrl9.AppendTextColumn(u"Date")
